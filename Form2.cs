...
namespace rumahSakit
{
    public partial class Form2 : Form
    {
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            //dimulai dari baris di bawah, komponen pada dataGridView1 komponen baru yaitu DataTable pada variabel dt
            ...
            using (XLWorkbook wb = new XLWorkbook())
            {
                ...
                {
                    wb.SaveAs(stream);
                    //membuka save file dialog untuk menentukan tempat file
                    ...
                    {
                        //menyimpan file dengan nama dan lokasi yang dipilih  user
